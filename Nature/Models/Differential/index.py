...
# MODELO DE EVOLUÇÃO DIFERENCIAL CLÁSSICA — CRIADO PELO NatureSelector COM name='differential'. MONO-OBJETIVO.
class DifferentialEvolution:
    ...
    def __init__(self, objective, variables, maximize=True, population=50, generations=200, F=(0.5, 1.0),
                 CR=0.9, strategy='current-to-best/1/bin', patience=None, constraints=None, seed=None, memory=None,
    ...
    def update(self):
        ...
        self.memory   = Memory(self.memoryPath, 'differential', self.config(), self.problem, self.recorder)
    ...
    def config(self):
        return {'population': self.population, 'generations': self.generations, 'F': list(self.F), 'CR': self.CR, 'strategy': self.strategy, 'patience': self.patience}
